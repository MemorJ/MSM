// ===== Configuration =====
const CONFIG = {
  password: 'msm', // Change this to your secret password (case-insensitive)
...
function drawGradientBackground() {
  ...
  gradient.addColorStop(0, 'hsl(349, 31%, 54%)');
  gradient.addColorStop(0.4, 'hsl(332, 53%, 73%)');
  gradient.addColorStop(0.7, 'hsl(340, 39%, 67%)');
  gradient.addColorStop(1, 'hsla(350, 47%, 29%, 0.75)');
